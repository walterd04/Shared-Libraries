...
{
    public class SimplePasswordEncryption<T> : ISimplePasswordEncryption<T> where T : class
    {
        ...
        public SimplePasswordEncryption(IOptions<PasswordHasherOptions> optionsAccessor = null)
        {
            ...
            switch(_compatibilityMode)
            {
                ...
                case PasswordHasherCompatibilityMode.IdentityV3:
                    ...
                    if (_iterCount < 1) throw new InvalidOperationException();
                    break;
                default:
        ...
        public virtual string HashPassword(T user, string password)
        {
            if (password == null)
            {
            ...
            {
                return Convert.ToBase64String(HashPasswordV2(password, _randomNumberGenerator));
            }
            else
            {
                return Convert.ToBase64String(HashPasswordV3(password, _randomNumberGenerator));
            }
        }
        ...
        public virtual PasswordVerificationResult VerifyHashedPassword(T user, string hashedPassword, string providedPassword)
        {
